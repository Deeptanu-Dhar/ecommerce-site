<?php 
	...
	$records = $mysqli->query("SELECT * FROM products where product_name like '%{$search}%'");
	...
	$result = $mysqli->query("SELECT * FROM products where product_name like '%{$search}%' LIMIT $start, $rows_per_page");
